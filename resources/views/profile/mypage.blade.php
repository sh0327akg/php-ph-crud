    ...
    <div class="container px-5 mx-auto flex flex-col justify-center">
      <div class="sm:flex-row mt-10">
        ...
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8 mx-auto">
          ...
          <div class="mt-4 sm:mt-0 sm:flex sm:items-center sm:space-x-4 justify-center">
              <div class="total-likes text-sm font-semibold">総獲得いいね数: {{ $total_likes }}</div>
              <div class="total-satisfaction text-sm font-semibold">総満足度: {{ $total_satisfaction }}</div>
          </div>
        </div>      
